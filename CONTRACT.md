...
The normative contract is [`schema/model-selection-catalog-v1.schema.json`](schema/model-selection-catalog-v1.schema.json).
...
All metrics come from the same released DeepSWE configuration. The recorded provider, mini-swe-agent harness, trial counts, confidence interval, source release, and source checksums are retained in provenance.
